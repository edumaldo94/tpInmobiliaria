...
public int Create(Inmueble property)
{
    ...
    using (var connection = new MySqlConnection(ConnectionString))
    {
        var sql = @$"INSERT INTO inmuebles ({nameof(Inmueble.PropietarioId)}, {nameof(Inmueble.Direccion)},{nameof(Inmueble.Ambientes)},  {nameof(Inmueble.Uso)}, {nameof(Inmueble.Tipo)}, {nameof(Inmueble.Precio)}, {nameof(Inmueble.Disponible)},{nameof(Inmueble.EstadoIn)})
                    VALUES (@{nameof(Inmueble.PropietarioId)}, @{nameof(Inmueble.Direccion)},@{nameof(Inmueble.Ambientes)},  @{nameof(Inmueble.Uso)}, @{nameof(Inmueble.Tipo)}, @{nameof(Inmueble.Precio)}, @{nameof(Inmueble.Disponible)},1);
